...
class TestPhonebook:
    ...
    # Testa a adição de um número de tefefone válido
       phone = Phonebook()
       result = phone.add('Joao', '123456789')
       expected = 'Numero adicionado'
   ...
   def test_add_invalid_name_character(self):
       ...
       phone = Phonebook()
       expected = 'Nome invalido'
       character = ['Joao!', 'Joa@', 'Joa$o', 'Joao%', 'J#oao']
   ...
   def test_search_sucess(self):
       ...
       phone.add('Joao', '123456789')
       expected = 'Joao'
       result = phone.search('Joao')
       assert result == expected

   def test_search_sucess2(self):
       #testa a busca de um nome no telefone
       phone = Phonebook()
       expected = 'Leonardo'
       list = ['Leonardo', 'Joao', 'Maria']
   ...
   def test_search_not_found2(self):
       # Testa a busca de um nome que não existe no telefone
       phone = Phonebook()
       expected = 'Contato nao encontrado'
       list = {'Leonardo': '123456', 'Joao': '123456789', 'Maria': '123456789'}
       for name, number in list.items():
           phone.add(name, number)
